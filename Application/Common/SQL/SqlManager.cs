...
namespace Application.Common.SQL
{
    public class SqlManager
    {
        ...
        public async Task<CompareResponse> CompareSqlResultsAsync(string sql1, string sql2)
        {
            ...
            //                        ("127.0.0.1", 5001)
            //                    };
            //var sqlClient1 = new SqlClient(new List<(string, int)> { servers[0] }); 
            //var sqlClient2 = new SqlClient(new List<(string, int)> { servers[1] }); 

            //var task1 = sqlClient1.ExecuteQueryAsync(sql1);
            //var task2 = sqlClient2.ExecuteQueryAsync(sql2);
